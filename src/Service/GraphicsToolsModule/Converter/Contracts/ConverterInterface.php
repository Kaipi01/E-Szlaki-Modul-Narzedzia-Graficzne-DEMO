...
interface ConverterInterface
{
     ...
     * @param bool $addCompress Czy odrazu skompresować ?
     * @param int $quality Jakość konwersji (1-100)
     * @return ConversionResults Wyniki konwersji grafiki
     */
    public function convert(string $imagePath, string $convertToType, bool $addCompress = false, int $quality = 100): ConversionResults;
}