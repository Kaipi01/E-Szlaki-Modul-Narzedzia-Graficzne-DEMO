...
// CompressionProcessHandler czyściutki bez serializacji i tym podobne

// cache-uj i serializuj TYLKO dane zwracane przez metody jak:
...
// dodaj metodę load, która załaduje dane z wyżej niezbędne do operacji (nie w konstruktorze aby symfony kontener wszyknął zależności)



class CompressionProcessHandler2 implements \Serializable
{
    private ?CompressionResults $compressionResults = null;
